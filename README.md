...
- `--atol`: Absolute tolerance for correctness check (default: `1.3e-6`)
- `--rtol`: Relative tolerance for correctness check (default: `1e-5`)
...
|-------------|----------------|-----------------|---------|
| **2048 × 1024** | 0.10 | 0.05 | 0.48x |
| **2048 × 1536** | 0.09 | 0.08 | 0.89x |
| **2048 × 2048** | 0.13 | 0.12 | 0.91x |
| **2048 × 7168** | 0.48 | 0.47 | 0.98x |
| **3100 × 1536** | 0.11 | 0.12 | **1.13x** 🚀 |
| **3100 × 2048** | 0.14 | 0.18 | **1.28x** 🚀 |
| **3100 × 7168** | 0.71 | 0.70 | 0.98x |
